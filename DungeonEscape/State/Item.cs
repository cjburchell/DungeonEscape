...
namespace Redpoint.DungeonEscape.State
{
    ...
    public class Item
    {
        ...
        public static Item CreateRandomItem(IEnumerable<ItemDefinition> itemDefinitions, IEnumerable<Item> staticItems,
            List<StatName> statNames, int maxLevel, int minLevel = 1, Rarity? rarity = null)
        {
