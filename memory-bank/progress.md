...
- `TitleViewModel` and `GameMenuViewModel` added under the core `ViewModels` namespace; title navigation/create state and game-menu screen/selection state have matching core tests.
